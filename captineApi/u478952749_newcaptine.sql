...
(1, 'admin', NULL, 'admin@gmail.com', 'admin123', '0991076973', 1, NULL, 'admin'),
...
(6, 'IMG_20231213_044440.jpg', '933333333333');
...
(25, 5, '62', '183', '23', 'HHH', 'HOMS', '7', '20', 'عالي', 'GGGG', 'زيادة وزن وحجم', 'الخيار للمدرب', 'FGFGFGFG', 'DFSFDSDF'),
...
(2, 3, 'couch.jpg'),
(5, 4, '3.jpg'),
(8, 5, 'IMG_20231213_044440.jpg'),
(9, 7, 'IMG_20231204_152939.jpg');
...
--
ALTER TABLE `bodyimages`
  MODIFY `body_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `exercises`
  MODIFY `exe_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `subscribe`
  MODIFY `subscribe_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `supplements`
--
ALTER TABLE `supplements`
  MODIFY `supp_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
